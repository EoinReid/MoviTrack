    ...
    public void start() {
        try {
            ...
            while (true) // loop continuously to accept new client connections
            {
                ...
                LOGGER.info("A Client has connected from the address: "+ socket.getInetAddress());
    ...
    public class ClientHandler implements Runnable // each ClientHandler communicates with one Client
    {
        ...
        public void run() {
            ...
            try {
                ...
                {
                    LOGGER.info("Command Received from the client: "+message);
                    ...
                    if(cache.containsKey(message)){
                        ...
                        socketWriter.println("The movie you have watched has been added to the database");
                         ...
                         List<String> directors = watchDao.recommendMovie(user); //Returns a list of directors watched by this user
                         int max = directors.size();
                         int randNum = ThreadLocalRandom.current().nextInt(0,max); //picks a director from the list of directors that have made movies they watched
                         String mdirector = directors.get(randNum);
